...
/*
	...
	Некорректное поведение: накапливание результатов выполнения одной функциис последующей отправкой в следущую.
	это не позволяет запускать на конвейере бесконечные задачи

	Корректное поведение: обеспечение беспрепятственного потока
*/
